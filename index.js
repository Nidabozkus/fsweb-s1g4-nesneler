...
*/
console.log(MenuElemaniOlustur("dört peynirli pizza", 120, "pizza"));
console.log(MenuElemaniOlustur("waffle", 130, "tatlılar"));
console.log(MenuElemaniOlustur("sezar salata", 80, "salatalar"));
